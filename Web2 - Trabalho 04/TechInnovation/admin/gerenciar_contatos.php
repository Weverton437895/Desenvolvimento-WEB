...
$query = $pdo->query("SELECT * FROM contato ORDER BY data_envio DESC");
...
<body>
    <header>
        <div class="header-container">
            <div class="logo"><h1>Admin - Contatos</h1></div>
            <nav class="navbar">
                <ul>
    ...
    <div class="container" style="margin-top: 30px;">
        ...
        <?php if (empty($contatos)): ?>
            <p style="text-align: center; color: #999; padding: 40px;">Nenhuma mensagem.</p>
        <?php else: ?>
                    ...
                    <tbody>
                        <?php foreach ($contatos as $contato): ?>
                            <tr>
                                ...
                                <td><?php echo htmlspecialchars(substr($contato['mensagem'], 0, 50)) . '...'; ?></td>
                                <td><?php echo date('d/m/Y H:i', strtotime($contato['data_envio'])); ?></td>
                                <td style="text-align: center;">
                                    <a href="deletar_contato.php?id=<?php echo $contato['id']; ?>" 
